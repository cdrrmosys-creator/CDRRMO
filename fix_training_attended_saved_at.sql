-- =====================================================
-- FIX: Training Attended saved_at Column Setup
-- =====================================================
...
-- Step 3: Drop and recreate the trigger for training_attended
...
SELECT 
  ...
  END as status
FROM pg_trigger 
WHERE tgname = 'trg_saved_at_training_attended'

UNION ALL

SELECT 
  'Records with saved_at' as check_type,
  COUNT(*)::text || ' / ' || (SELECT COUNT(*) FROM training_attended)::text as status
