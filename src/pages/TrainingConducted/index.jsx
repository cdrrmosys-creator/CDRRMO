  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        ...
        alert('Training conducted record updated successfully!')
      } else {
        const { data, error } = await supabase
          .from('training_conducted')
          .insert([formData])
        ...
        alert('Training conducted record added successfully!')
      }
  ...
  return (
    <div>
      ...
      <Modal
        ...
        title={isEditing ? 'Edit Training Conducted' : 'Log Training Conducted'}
      >
